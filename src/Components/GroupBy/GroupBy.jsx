...
import arrowSortedUp from "@iconify/icons-typcn/arrow-sorted-up";
import arrowSortedDown from "@iconify/icons-typcn/arrow-sorted-down";
...
function GroupBy(props) {
  ...
  if (!props.showGroubByOrder) {
    orderSymbol = <Icon icon={arrowSortedUp} />;
  } else {
    orderSymbol = <Icon icon={arrowSortedDown} />;
  }
